...
% Last Modified by GUIDE v2.5 03-Mar-2018 21:37:42
...
% --- Executes on button press in BEmpezar.
function BEmpezar_Callback(hObject, eventdata, handles)
% hObject    handle to BEmpezar (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes on button press in BCrear.
...
% --- Executes on button press in BAbrir.
